...
datJ <- list(
  ...
  r = c(rep(1,19), rep(2,19), rep(3,(nrow(dat)-19-19))),
...
model <- jags.model(file = "sens1-model.jag", data = datJ, n.chains = 4, n.adapt = 5000)
...
save(res, summ, E, I, R, file="sens1-results.RData")
